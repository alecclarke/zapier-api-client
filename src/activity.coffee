...
Zap.new_activity_post_poll = (bundle) ->
  ...
  Zap.process_activity_response_content(results)

Zap.new_activity_webhook_catch_hook = (bundle) ->
  response_content = Zap.get_content_from_skinny_hook(bundle, "activity", "activities")
  return Zap.process_activity_response_content(response_content)
...
Zap.process_activity_response_content = (response_content) ->
  array = []
  for object in response_content.activities
